...
powershell.exe -nologo -noprofile -command "& {Add-Type -A System.IO.Compression.FileSystem;[IO.Compression.ZipFile]::CreateFromDirectory('src\ForeverCore\bin\Release\netcoreapp2.0\linux-arm\publish', 'linux-arm.zip');}"
powershell.exe -nologo -noprofile -command "& {Add-Type -A System.IO.Compression.FileSystem;[IO.Compression.ZipFile]::CreateFromDirectory('src\ForeverCore\bin\Release\netcoreapp2.0\linux-x64\publish', 'linux-x64.zip');}"
powershell.exe -nologo -noprofile -command "& {Add-Type -A System.IO.Compression.FileSystem;[IO.Compression.ZipFile]::CreateFromDirectory('src\ForeverCore\bin\Release\netcoreapp2.0\win-x86\publish', 'win-x86.zip');}"
powershell.exe -nologo -noprofile -command "& {Add-Type -A System.IO.Compression.FileSystem;[IO.Compression.ZipFile]::CreateFromDirectory('src\ForeverCore\bin\Release\netcoreapp2.0\win-x64\publish', 'win-x64.zip');}"